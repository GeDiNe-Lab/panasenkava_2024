...
markers <- read.table("/home/jules/Documents/phd/Data/Article_veranika/genes_intermediaires.csv", sep = ",", header = TRUE)
markers
...
png(filename = "results/images/Figure_1/F1_1_inter_marker_HM.png", width = 2000, height = 1800, res = 250)
Heatmap(
